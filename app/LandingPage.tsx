      ...
      <header className="sticky top-0 z-40 border-b border-white/10 backdrop-blur supports-[backdrop-filter]:bg-white/5">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
            <Link href="/dashboard" className="hidden md:flex items-center rounded-sm bg-gradient-to-r from-[#25adef] to-[#5b7ce6] px-4 py-3 text-sm font-semibold text-white shadow hover:from-[#1e9bd6] hover:to-[#4a6cd5] focus:outline-none focus:ring-2 focus:ring-[#25adef]/50">
              Reuest a Demo <ArrowRight className="h-4 w-4 font-bold" />
            </Link>
            <button
      ...
      <div className={`fixed top-0 right-0 h-full w-80 bg-slate-950 shadow-2xl transform transition-transform duration-300 ease-in-out z-50 md:hidden ${
        ...
        <div className="p-6 space-y-6 flex flex-col h-full">
          ...
          <div className="mt-auto pt-6 border-t border-white/10">
            <Link href="/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center gap-2 rounded-sm bg-gradient-to-r from-[#25adef] to-[#5b7ce6] px-4 py-3 text-sm font-semibold text-white hover:from-[#1e9bd6] hover:to-[#4a6cd5] transition-colors">
      ...
      <section className="relative mx-auto max-w-5xl px-4 pt-32 pb-20 text-center">
        <div className="space-y-8 scroll-reveal">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <Link href="/dashboard" className="inline-flex items-center gap-2 rounded-sm bg-gradient-to-r from-[#25adef] to-[#5b7ce6] px-6 py-4 text-sm font-semibold text-white hover:from-[#1e9bd6] hover:to-[#4a6cd5] focus:outline-none focus:ring-2 focus:ring-[#25adef]/50 transition-all">
              Try the Agent <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="#features" className="rounded-sm border border-[#25adef]/30 bg-[#25adef]/5 px-6 py-4 text-sm font-semibold text-white hover:bg-[#25adef]/10 focus:outline-none focus:ring-2 focus:ring-[#25adef]/20 transition-all">
              View Features
            </Link>
          </div>
